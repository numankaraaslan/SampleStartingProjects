package com.example.springjdbcthymeleaf.controller;
...
import com.example.springjdbcthymeleaf.repo.BookRepo;

// http://localhost:8080/SpringJDBCThymemelaf/index
@Controller
public class ThymeleafController
{
	...
	public ModelAndView getbookdetail(@RequestParam(name = "id") int id)
	{
		...
		view.addObject("book", bookRepo.getByID(id));
		return view;
	}
